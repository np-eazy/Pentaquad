      ...
      if (count >= threshold) {
        ...
        if (dxn.equals(Dxn[Angle.RIGHT])) {
          ...
          for (var y_ = 0; y_ < BOARD_SIZE; y_++) {
            ...
            board[y_][0] = coreState.emptyCellProvider.newCell(coreState);
          ...
          for (var y_ = 0; y_ < BOARD_SIZE; y_++) {
            board[y_][BOARD_SIZE - 1] = coreState.emptyCellProvider.newCell(coreState);
    ...
    for (var y = 0; y < BOARD_SIZE; y++) {
      ...
      if (count >= threshold) {
        ...
        if (dxn.equals(Dxn[Angle.DOWN])) {
          ...
          for (var x_ = 0; x_ < BOARD_SIZE; x_++) {
            board[0][x_] = coreState.emptyCellProvider.newCell(coreState);
          ...
          for (var x_ = 0; x_ < BOARD_SIZE; x_++) {
            board[BOARD_SIZE - 1][x_] = coreState.emptyCellProvider.newCell(coreState);
